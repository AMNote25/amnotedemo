...
export function ReceiptTableToolbar({
  ...
  return (
    <div className="block sm:flex items-center justify-between p-6 border-b border-gray-200">
      <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-4">
        ...
        {onSearch && (
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Tìm kiếm số chứng từ, người nhận..."
              value={searchTerm}
      ...
      {selectedCount > 0 && onBulkDelete && (
        <div className="flex mt-4 sm:mt-0 items-center space-x-4">
          <span className="text-sm text-gray-600">Đã chọn {selectedCount} phiếu thu</span>
          <button
